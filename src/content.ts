...
export const WORKLOADS = {
  ...
  examples: [
    ...
    },
    {
      icon: "house",
      metric: "1.7M",
      metricLabel: "Airbnb photo rows processed",
      domain: "ML",
      title: "Analyze 1.7M Airbnb photo rows",
      desc: "Run staged CLIP, embedding, and Haiku filters across 119 cities.",
    ...
    },
    {
      ...
      desc: "Embed text on up to eight GPUs, persist vector shards, and search them locally.",
    ...
    },
    {
      icon: "pin",
      metric: "9.5M",
      metricLabel: "geotagged metadata rows indexed",
      domain: "Geospatial",
      title: "Map 9.5M geotagged photos",
      desc: "Reverse-geocode 4,094 Flickr shards into a browsable geographic index.",
    ...
    },
    {
      ...
      domain: "Geospatial",
      hideOnHome: true,
      title: "Compute Sentinel-2 NDVI in parallel",
    ...
    },
    {
      icon: "dice",
      metric: "NumPy",
      metricLabel: "paths reduced to compact statistics",
      domain: "Finance",
      hideOnHome: true,
      title: "Price an option with parallel Monte Carlo",
    ...
    },
    {
      ...
      desc: "Stream 275GB across 545 jobs and reduce bounded candidates.",
