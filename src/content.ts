...
export const WORKLOADS = {
  ...
  examples: [
    ...
    },
    {
      icon: "house",
      metric: "1.7M",
      metricLabel: "Airbnb photos scored with CLIP",
      domain: "ML",
      title: "Rank 1.7M Airbnb photos with CLIP",
      desc: "Score public listing photos in parallel, then return one ranked shortlist.",
    ...
    },
    {
      ...
      desc: "Count pickups across 371 monthly files and reduce them into zone histories.",
    ...
    },
    {
      ...
      desc: "Embed text on up to eight GPUs, then search the shared vectors on Burla.",
      href: "/docs/all-examples/ml-embeddings-and-search/gpu-embedding-demo",
    },
    {
      icon: "raindrop",
      metric: "GHCN",
      metricLabel: "annual files scanned in parallel",
      domain: "Geospatial",
      title: "Find NOAA's largest daily precipitation value",
      desc: "Reduce quality-controlled annual maxima into one global result.",
      href: "/docs/all-examples/scientific-and-geospatial-work/ghcn-rainiest-day",
    },
    {
      icon: "pin",
      metric: "9.5M",
      metricLabel: "Flickr rows reverse-geocoded",
      domain: "Geospatial",
      title: "Count 9.5M Flickr photos by country code",
      desc: "Map 4,094 metadata shards to nearest-city country codes and combine the counts.",
    ...
    },
    {
      ...
      desc: "Embed a fixed snapshot, assign 400 topics, and summarize representative papers.",
      href: "/docs/featured-examples/arxiv-fossils",
    },
    {
      icon: "raster",
      metric: "2,000 tiles",
      metricLabel: "turned into NDVI GeoTIFFs",
      domain: "Geospatial",
      hideOnHome: true,
      title: "NDVI over 2,000 Sentinel-2 tiles",
      desc: "Query public COGs, compute NDVI, and persist one GeoTIFF per tile.",
    ...
    },
    {
      ...
      desc: "Score 545 newline-aligned byte ranges once and reduce the global top 100.",
