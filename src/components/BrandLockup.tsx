...
export function BrandLockup() {
  ...
  return (
    <Link
      ...
      className="inline-flex min-h-11 items-center text-accent text-shadow-soft"
    >
      <span className="flex items-baseline gap-[5px] font-logo text-[21px] font-bold tracking-tight">
        <svg
          viewBox="0 0 12 18"
