  ...
  return (
    ...
    >
      {(filename || copy || titleRight) && (
        <div className={isCream ? "code-titlebar-cream" : "code-titlebar"}>
          <div className="flex items-center gap-3">
            <div className="traffic">
              <span style={{ background: isCream ? "#212931" : "#D2DAE2" }} />
              <span style={{ background: isCream ? "#212931" : "#D2DAE2" }} />
              <span style={{ background: isCream ? "#212931" : "#D2DAE2" }} />
            </div>
            {filename && (
      ...
      <pre
        className={`mono text-[12.5px] md:text-[13px] leading-[1.65] overflow-x-auto ${pad} ${
          ...
          {lines.map((line, idx) => {
            ...
            return (
              <div
                ...
                style={
                  highlighted ? { boxShadow: "inset 2px 0 0 #155E75" } : undefined
                }
              >
                {showLineNumbers && (
                  <span
